...
public:
	...
	{
		if (ele::SemanticInformation::invalidInViewFunctions(_instruction.instruction))
			m_reportMutability(StateMutability::NonPayable, _instruction.location);
		else if (ele::SemanticInformation::invalidInPureFunctions(_instruction.instruction))
