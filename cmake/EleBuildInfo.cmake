function(create_build_info NAME)
	...
	set(ELE_BUILD_PLATFORM "${ELE_BUILD_OS}.${ELE_BUILD_COMPILER}")
	...
	add_custom_target(${NAME}_BuildInfo.h ALL
		...
		COMMAND ${CMAKE_COMMAND} -DETH_SOURCE_DIR="${PROJECT_SOURCE_DIR}" -DETH_BUILDINFO_IN="${ELE_CMAKE_DIR}/templates/BuildInfo.h.in" -DETH_DST_DIR="${PROJECT_BINARY_DIR}/include/${PROJECT_NAME}" -DETH_CMAKE_DIR="${ELE_CMAKE_DIR}"
		-DETH_BUILD_TYPE="${_cmake_build_type}"
		-DETH_BUILD_OS="${ELE_BUILD_OS}"
		-DETH_BUILD_COMPILER="${ELE_BUILD_COMPILER}"
		-DETH_BUILD_PLATFORM="${ELE_BUILD_PLATFORM}"
