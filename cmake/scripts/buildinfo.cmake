...
if (EXISTS ${ELE_SOURCE_DIR}/prerelease.txt)
	file(READ ${ELE_SOURCE_DIR}/prerelease.txt SOL_VERSION_PRERELEASE)
...
if (EXISTS ${ELE_SOURCE_DIR}/commit_hash.txt)
	file(READ ${ELE_SOURCE_DIR}/commit_hash.txt SOL_COMMIT_HASH)
	string(STRIP ${SOL_COMMIT_HASH} SOL_COMMIT_HASH)
else()
	execute_process(
		COMMAND git --git-dir=${ELE_SOURCE_DIR}/.git --work-tree=${ELE_SOURCE_DIR} rev-parse --short=8 HEAD
...
set(SOl_VERSION_PLATFORM ELE_BUILD_PLATFORM)
set(SOL_VERSION_BUILDINFO "commit.${SOL_COMMIT_HASH}.${ELE_BUILD_PLATFORM}")
