...
Json::Value RPCSession::ele_getBlockByNumber(string const& _blockNumber, bool _fullObjects)
{
	// NOTE: to_string() converts bool to 0 or 1
	return rpcCall("ele_getBlockByNumber", { quote(_blockNumber), _fullObjects ? "true" : "false" });
}
