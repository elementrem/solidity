...
REM
REM See https://github.com/elementrem/cpp-dependencies
REM
...
REM     https://github.com/elementrem/webthree-umbrella/issues/345
REM
REM     See "Windows - Try to use NuGet C++ packages"
REM     https://github.com/elementrem/webthree-umbrella/issues/509
REM
REM     See "CM - Can we switch to NuGet delivery for our external dependencies"
REM     https://github.com/elementrem/webthree-umbrella/issues/376
REM
...
cmake -P scripts\install_ele.cmake
